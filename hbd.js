function initengahan(){
  ...
  document.getElementById("By").onclick = function()
   {if(fungsi==1){Tombol.style="";fthilang();fungsi=0;vketik8=vketik81;aktipesan8();} if(fungsi==2){Tombol.style="";pertanyaan();}}
  ...
  vketi5=pesa5.innerHTML;
  function aktipesa5(){
  wallpaper.style="transform: scale(1.5);";
  kolombaru.style="";kalimat.innerHTML="";
  new TypeIt("#kalimat", {
  strings: ["" + vketi5], startDelay: 20, speed: 40, cursor: true, deleteSpeed: 50, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    setTimeout(aktipesa1,800);
  },}).go();
  }
  ...
  afterComplete: function(){
    setTimeout(aktipesa5,800);
  },}).go();
  }

  vketi1=pesa1.innerHTML;
  function aktipesa1(){
  wallpaper.style="transform: scale(1.5);";
  kolombaru.style="";kalimat.innerHTML="";
  new TypeIt("#kalimat", {
  strings: ["" + vketi1], startDelay: 20, speed: 40, cursor: true, deleteSpeed: 50, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    setTimeout(aktipesa2,800);
  },}).go();
  }
  vketi2=pesa2.innerHTML;
  function aktipesa2(){
  wallpaper.style="transform: scale(1.5);";
  kolombaru.style="";kalimat.innerHTML="";
  new TypeIt("#kalimat", {
  strings: ["" + vketi2], startDelay: 20, speed: 40, cursor: true, deleteSpeed: 50, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    setTimeout(aktipesan3,800);
  },}).go();
  }
  ...
  afterComplete: function(){
    pesan3.innerHTML=vketik3;setTimeout(otomatis,600);setTimeout(aktipesa3,1010);
  },}).go();
  }
  vketi3=pesa3.innerHTML;
  function aktipesa3(){
  wallpaper.style="transform: scale(1.5);";
  kolombaru.style="";kalimat.innerHTML="";
  new TypeIt("#kalimat", {
  strings: ["" + vketi3], startDelay: 20, speed: 40, cursor: true, deleteSpeed: 50, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  afterComplete: function(){
    pesan7.innerHTML=vketik7;fungsi=1;setTimeout(tombol,500);
  },}).go();
  }
  //Pemisah
  ...
  async function pertanyaan(){var { isConfirmed: prtanya } = await swals.fire({title: tanya, imageUrl: '' + fotostiker6.src, showCancelButton: true, confirmButtonText: '' + tompositif, cancelButtonText: '' + tomnegatif,});
    if(prtanya){
